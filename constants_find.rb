...
# %w{ 0 1 Z # : $ j ? - / % \\ }.each do |c|
  %w{ 0 1 Z   : $   ? - / % \\ }.each do |c|
    ...
    next if %w{ 01-\\ 0Z-\\ 1Z-\\ 01\\/ 1:\\$ 01\\$ Z1\\$ 01\\% 1::\\ 01:\\ 1::/ Z::/ Z:Z/ 1:1- Z:Z- 1\\1\\ 1Z/? 0:Z/ 1-1- Z:1- }.include? code[-4,4]
    next if %w{ 0:1-% 101-% 01Z-% 01Z/% 0:Z-% 1:Z-% Z1Z-% 10Z-% 1:Z/% 1Z/1% 1Z/Z% 01-:/ 01-:\\ 0:1-/ 101-/ 0:1-- 0:1-\\ 0Z-:/ 0Z-:\\ 0Z-Z/ 1Z-:/ 1Z-:\\ 01Z-- 01Z-/ 01Z// 0:Z-/ 0:Z-- 10Z-- 1:Z-- 0:Z-\\ 1:Z-\\ 1:Z/- 1:Z// 1:Z/? 1Z/:/ 1Z/:? Z1Z/- Z01-% 1:\\1\\ }.include? code[-5,5]
    next if %w{ Z1Z//? }.include? code[-6,6]
    next if %w{ Z1Z//Z/ }.include? code[-7,7]

    next if %w{ 1\\ 1- 1% Z% Z- Z/ }.include? code[0,2]
    next if %w{ 01-% 0Z-% 01-/ 0Z-/ 01-- 0Z-- 1:\\? 1:\\- Z1\\- 1:\\/ Z1\\/ 1:\\$ 1:\\% Z1\\% 01\\\\ 1:\\\\ Z1\\\\ 01\\? 11\\? Z1\\? 01\\- 1Z-% 1Z-- 1Z-/ 1Z/% 1Z/- 1Z// }.include? code[0,4]
    next if %w{ 1:\\:/ 01\\1% 01\\1- 01\\Z% 01\\Z- 01\\Z/ 01\\:/ 1:\\1% 1:\\1- 01\\:? 01\\:\\ 1:\\:? 1:\\:\\ Z1\\Z- Z1\\Z% 1:\\Z% 1:\\Z- 1:\\Z/ 1Z-1- Z1\\Z/ Z1\\:? Z1\\:\\ Z1\\1% Z1\\1- Z1\\:/ }.include? code[0,5]
    ...
    next if result.stack.size > 30
    pcbr.store code, [(result.stack.size - 2).abs, base.size]
    best.push [result.stack[1].to_i, code] if result.stack.size == 2 && result.stack[0] == -70 && result.stack[1] > 0 && result.stack[1].denominator == 1
  end
end
