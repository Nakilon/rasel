...
# %w{ 0 1 Z # : $ j ? - / % \\ }.each do |c|
  %w{ 0 1 Z   : $   ? - / % \\ }.each do |c|
    ...
    next if %w{ 01-\\ 0Z-\\ 1Z-\\ 01\\/ 1:\\$ 01\\$ Z1\\$ 01\\% 1::\\ 01:\\ 1::/ Z::/ Z:Z/ 1:1- Z:Z- 1\\1\\ 1Z/? 0:Z/ 1-1- Z:1- Z1:\\ }.include? code[-4,4]
    next if %w{ 0:1-% 101-% 01Z-% 01Z/% 0:Z-% 1:Z-% Z1Z-% 10Z-% 1:Z/% 1Z/1% 1Z/Z% 01-:/ 01-:\\ 0:1-/ 101-/ 0:1-- 0:1-\\ 0Z-:/ 0Z-:\\ 0Z-Z/ 1Z-:/ 1Z-:\\ 01Z-- 01Z-/ 01Z// 0:Z-/ 0:Z-- 10Z-- 1:Z-- 0:Z-\\ 1:Z-\\ 1:Z/- 1:Z// 1:Z/? 1Z/:/ 1Z/:? Z1Z/- Z01-% 1:\\1\\ Z1Z/% 1Z-1- Z0Z-% Z0Z-/ Z01-/ }.include? code[-5,5]
    next if %w{ Z1Z//? }.include? code[-6,6]
    next if %w{ Z1Z//Z/ Z1Z//:? Z0Z--:? }.include? code[-7,7]
